...
Currently building labs, testing things, and learning how to secure them. <br/>
🧪 Working on: <br/>

CCNA & networking labs <br/>
Fortinet security labs <br/>
Microsoft security labs <br/>
Pentesting & CTFs  <br/><br/>
